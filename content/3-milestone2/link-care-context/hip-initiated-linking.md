...
- if the HRP does not have a valid linking token, they need to generate linking token via [demographic auth.](/abdm-docs/2-milestone1/verify-abha-address/demographics/)
